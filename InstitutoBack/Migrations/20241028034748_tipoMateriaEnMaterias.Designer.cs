...
namespace InstitutoBack.Migrations
{
    ...
    [Migration("20241028034748_tipoMateriaEnMaterias")]
    partial class tipoMateriaEnMaterias
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.Inscripcion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CicloLectivoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 28, 0, 47, 47, 513, DateTimeKind.Local).AddTicks(9650)
                        });
                });
