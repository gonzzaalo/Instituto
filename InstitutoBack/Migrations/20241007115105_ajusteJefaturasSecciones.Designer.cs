...
namespace InstitutoBack.Migrations
{
    ...
    [Migration("20241007115105_ajusteJefaturasSecciones")]
    partial class ajusteJefaturasSecciones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.Inscripcion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CicloLectivoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 7, 8, 51, 4, 716, DateTimeKind.Local).AddTicks(4731)
                        });
                });
