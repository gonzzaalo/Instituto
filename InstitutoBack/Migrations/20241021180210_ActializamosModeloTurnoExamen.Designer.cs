...
namespace InstitutoBack.Migrations
{
    ...
    [Migration("20241021180210_ActializamosModeloTurnoExamen")]
    partial class ActializamosModeloTurnoExamen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.Inscripcion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CicloLectivoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 21, 15, 2, 6, 680, DateTimeKind.Local).AddTicks(744)
                        });
                });
