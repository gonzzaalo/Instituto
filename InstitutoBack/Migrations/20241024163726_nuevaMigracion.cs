    ...
    public partial class nuevaMigracion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Rubén Alejandro Ramirez", "Bv Roque Saenz Peña 2942", false, "aleramirezsj@gmail.com", "15447106" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Actual", "Eliminado", "Nombre" },
                values: new object[] { 1, false, false, "2024" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Actual", "Eliminado", "Nombre" },
                values: new object[] { 1, false, false, "Julio/Agosto 2024" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, 1, false, new DateTime(2024, 10, 24, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(2270) });
            ...
            migrationBuilder.InsertData(
                table: "materias",
                columns: new[] { "Id", "AnioCarreraId", "Eliminado", "EsRecreo", "Nombre" },
                values: new object[,]
                {
                    { 1, 21, false, false, "Pedagogía" },
                    { 2, 21, false, false, "UCCV Sociología" },
                    { 3, 21, false, false, "Administración General" },
                    { 4, 21, false, false, "Economía I" },
                    { 5, 21, false, false, "Geografía Económica" },
                    { 6, 21, false, false, "Historia Económica" },
                    { 7, 21, false, false, "Construcción de Ciudadanía" },
                    { 8, 21, false, false, "Sistema de Información Contable I" },
                    { 9, 21, false, false, "Matemática" },
                    { 10, 21, false, false, "Práctica Docente I" },
                    { 11, 22, false, false, "Instituciones Educativas" },
                    { 12, 22, false, false, "Didáctica y Curriculum" },
                    { 13, 22, false, false, "Psicología y Educación" },
                    { 14, 22, false, false, "Economía II" },
                    { 15, 22, false, false, "Sistema de Información Contable II" },
                    { 16, 22, false, false, "Derecho I" },
                    { 17, 22, false, false, "Estadística Aplicada" },
                    { 18, 22, false, false, "Didáctica de la Economía I" },
                    { 19, 22, false, false, "Práctica Docente II" },
                    { 20, 23, false, false, "Historia y Política de la Educación Argentina" },
                    { 21, 23, false, false, "Filosofía" },
                    { 22, 23, false, false, "Metodología de la Investigación" },
                    { 23, 23, false, false, "Economía III" },
                    { 24, 23, false, false, "Finanzas Públicas" },
                    { 25, 23, false, false, "Derecho II" },
                    { 26, 23, false, false, "Sujetos de la Educación Secundaria" },
                    { 27, 23, false, false, "Práctica Docente III" },
                    { 28, 23, false, false, "Producción de los Recursos Didácticos I" },
                    { 29, 24, false, false, "Ética y Trabajo Docente" },
                    { 30, 24, false, false, "Educación Sexual Integral" },
                    { 31, 24, false, false, "UCCV Comunicación Social" },
                    { 32, 24, false, false, "Economía Social y Sostenible" },
                    { 33, 24, false, false, "Economía Argentina Latinoamericana e Internacional" },
                    { 34, 24, false, false, "Prácticas de Investigación" },
                    { 35, 24, false, false, "Práctica Docente IV (Residencia)" },
                    { 36, 24, false, false, "Producción de los Recursos Didácticos II" },
                    { 37, 24, false, false, "Unidad de Definición Institucional" },
                    { 38, 25, false, false, "Pedagogía" },
                    { 39, 25, false, false, "Movimiento y Cuerpo" },
                    { 40, 25, false, false, "Práctica Docente I: Escenarios Educativos" },
                    { 41, 25, false, false, "Introducción a la Tecnología" },
                    { 42, 25, false, false, "Historia de la Tecnología" },
                    { 43, 25, false, false, "Diseño y Producción de la Tecnología I" },
                    { 44, 25, false, false, "Matemática" },
                    { 45, 25, false, false, "Física" },
                    { 46, 26, false, false, "Psicología de la Educación" },
                    { 47, 26, false, false, "Didáctica y Curriculum" },
                    { 48, 26, false, false, "Instituciones Educativas" },
                    { 49, 26, false, false, "Práctica Docente II: La Institución Escolar" },
                    { 50, 26, false, false, "Sujetos de la Educación I" },
                    { 51, 26, false, false, "Tics para la Enseñanza" },
                    { 52, 26, false, false, "Procesos Productivos" },
                    { 53, 26, false, false, "Diseño y Producción Tecnológica II" },
                    { 54, 26, false, false, "Didáctica Específica I" },
                    { 55, 27, false, false, "Filosofía y Educación" },
                    { 56, 27, false, false, "Historia Social de la Educación" },
                    { 57, 27, false, false, "Metodología de la Investigación" },
                    { 58, 27, false, false, "Práctica Docente III: La Clase" },
                    { 59, 27, false, false, "Sujetos de la Educación II" },
                    { 60, 27, false, false, "Materiales" },
                    { 61, 27, false, false, "Química" },
                    { 62, 27, false, false, "Procesos de Control" },
                    { 63, 27, false, false, "Tecnologías Regionales" },
                    { 64, 27, false, false, "Diseño y Producción Tecnológica III" },
                    { 65, 27, false, false, "Didáctica Específica II" },
                    { 66, 28, false, false, "Ética y Trabajo Docente" },
                    { 67, 28, false, false, "Educación Sexual Integral" },
                    { 68, 28, false, false, "Unidades de Definición Institucional I" },
                    { 69, 28, false, false, "Unidades de Definición Institucional II" },
                    { 70, 28, false, false, "Prácticas de Investigación" },
                    { 71, 28, false, false, "Práctica Docente IV: El Rol Docente y su Práctica" },
                    { 72, 28, false, false, "Biotecnología" },
                    { 73, 28, false, false, "Procesos de Comunicación" },
                    { 74, 28, false, false, "Problemáticas Sociotécnicas" },
                    { 75, 28, false, false, "Diseño y Producción Tecnológica IV" },
                    { 76, 28, false, false, "Taller de Producción Didáctica" },
                    { 77, 1, false, false, "Comunicación (1° cuat.)" },
                    { 78, 1, false, false, "Unidad de definición Institucional (2° cuat.)" },
                    { 79, 1, false, false, "Matemática" },
                    { 80, 1, false, false, "Inglés Técnico I" },
                    { 81, 1, false, false, "Administración" },
                    { 82, 1, false, false, "Tecnología de la Información" },
                    { 83, 1, false, false, "Lógica y Estructura de Datos" },
                    { 84, 1, false, false, "Ingeniería de Software I" },
                    { 85, 1, false, false, "Sistemas Operativos" },
                    { 86, 2, false, false, "Problemáticas Socio Contemporáneas (1° cuat.)" },
                    { 87, 2, false, false, "Unidad de definición Institucional (2° cuat.)" },
                    { 88, 2, false, false, "Inglés Técnico II" },
                    { 89, 2, false, false, "Innovación y Desarrollo Emprendedor" },
                    { 90, 2, false, false, "Estadística" },
                    { 91, 2, false, false, "Programación I" },
                    { 92, 2, false, false, "Ingeniería de Software II" },
                    { 93, 2, false, false, "Base de Datos I" },
                    { 94, 2, false, false, "Práctica Profesionalizante I" },
                    { 95, 3, false, false, "Ética y Responsabilidad Social" },
                    { 96, 3, false, false, "Derecho y Legislación Laboral" },
                    { 97, 3, false, false, "Redes y Comunicación" },
                    { 98, 3, false, false, "Programación II" },
                    { 99, 3, false, false, "Gestión de Proyectos de Software" },
                    { 100, 3, false, false, "Base de Datos II" },
                    { 101, 3, false, false, "Práctica Profesionalizante II" },
                    { 102, 10, false, false, "Comunicación" },
                    { 103, 10, false, false, "Unidad de Definición Institucional I" },
                    { 104, 10, false, false, "Salud Pública" },
                    { 105, 10, false, false, "Biología Humana I" },
                    { 106, 10, false, false, "Sujeto, Cultura y Sociedad" },
                    { 107, 10, false, false, "Fundamentos del Cuidado en Enfermería" },
                    { 108, 10, false, false, "Cuidados de Enfermería en la Comunidad y en la Familia" },
                    { 109, 10, false, false, "Práctica Profesionalizante I" },
                    { 110, 11, false, false, "Problemáticas Socio Contemporáneas" },
                    { 111, 11, false, false, "Unidad de Definición Institucional II" },
                    { 112, 11, false, false, "Informática en Salud" },
                    { 113, 11, false, false, "Sujeto, Cultura y Sociedad II" },
                    { 114, 11, false, false, "Biología Humana II" },
                    { 115, 11, false, false, "Bioseguridad y Medio Ambiente en el Trabajo" },
                    { 116, 11, false, false, "Farmacología en Enfermería" },
                    { 117, 11, false, false, "Cuidados de Enfermería a los Adultos y Adultos Mayores" },
                    { 118, 11, false, false, "Práctica Profesionalizante II" },
                    { 119, 12, false, false, "Ética y Responsabilidad Social" },
                    { 120, 12, false, false, "Derecho y Legislación Laboral" },
                    { 121, 12, false, false, "Inglés Técnico" },
                    { 122, 12, false, false, "Organización y Gestión en Instituciones de Salud" },
                    { 123, 12, false, false, "Investigación en Enfermería" },
                    { 124, 12, false, false, "Cuidados de Enfermería en Salud Mental" },
                    { 125, 12, false, false, "Cuidados de Enfermería al Niño y al Adolescente" },
                    { 126, 12, false, false, "Práctica Profesionalizante III" },
                    { 127, 7, false, false, "Comunicación (1º cuatr.)" },
                    { 128, 7, false, false, "Unidad de Definición Institucional (2º cuatr.)" },
                    { 129, 7, false, false, "Economía" },
                    { 130, 7, false, false, "Matemática y Estadística" },
                    { 131, 7, false, false, "Contabilidad" },
                    { 132, 7, false, false, "Informática" },
                    { 133, 7, false, false, "Administración" },
                    { 134, 7, false, false, "Gestión de la Producción" },
                    { 135, 7, false, false, "Gestión del Talento Humano" },
                    { 136, 8, false, false, "Problemáticas Contemporáneas (1º cuatr.)" },
                    { 137, 8, false, false, "Unidad de Definición Institucional (2º cuatr.)" },
                    { 138, 8, false, false, "Innovación y Desarrollo Emprendedor" },
                    { 139, 8, false, false, "Inglés Técnico" },
                    { 140, 8, false, false, "Legislación Comercial y Tributaria" },
                    { 141, 8, false, false, "Gestión de Comercialización e Investigación Comercial" },
                    { 142, 8, false, false, "Gestión de Costos" },
                    { 143, 8, false, false, "Gestión Contable" },
                    { 144, 8, false, false, "Práctica Profesionalizante I" },
                    { 145, 9, false, false, "Gestión de Seguridad, Salud Ocupacional y Medio Ambiente" },
                    { 146, 9, false, false, "Ética y Responsabilidad Social" },
                    { 147, 9, false, false, "Legislación Laboral" },
                    { 148, 9, false, false, "Estrategia Empresarial" },
                    { 149, 9, false, false, "Sistema de Información para la Gestión de las Organizaciones" },
                    { 150, 9, false, false, "Gestión Financiera" },
                    { 151, 9, false, false, "Evaluación y Administración de Proyectos de Inversión" },
                    { 152, 9, false, false, "Control de Gestión" },
                    { 153, 9, false, false, "Prácticas Profesionalizantes II" },
                    { 154, 4, false, false, "Comunicación (1° cuat.)" },
                    { 155, 4, false, false, "Unidad de definición Institucional (2° cuat.)" },
                    { 156, 4, false, false, "Matemática" },
                    { 157, 4, false, false, "Física Aplicada a las Tecnologías de la Información" },
                    { 158, 4, false, false, "Administración" },
                    { 159, 4, false, false, "Inglés Técnico" },
                    { 160, 4, false, false, "Arquitectura de las Computadoras" },
                    { 161, 4, false, false, "Lógica y Programación" },
                    { 162, 4, false, false, "Infraestructura de Redes I" },
                    { 163, 5, false, false, "Problemáticas Socio Contemporáneas (1° cuat.)" },
                    { 164, 5, false, false, "Unidad de definición Institucional (2° cuat.)" },
                    { 165, 5, false, false, "Innovación y Desarrollo Emprendedor" },
                    { 166, 5, false, false, "Estadística" },
                    { 167, 5, false, false, "Sistemas Operativos" },
                    { 168, 5, false, false, "Algoritmos y Estructuras de Datos" },
                    { 169, 5, false, false, "Base de Datos" },
                    { 170, 5, false, false, "Infraestructura de Redes II" },
                    { 171, 5, false, false, "Práctica Profesionalizante I" },
                    { 172, 6, false, false, "Ética y Responsabilidad Social" },
                    { 173, 6, false, false, "Derecho y Legislación Laboral" },
                    { 174, 6, false, false, "Administración de Base de Datos" },
                    { 175, 6, false, false, "Integridad y Migración de Datos" },
                    { 176, 6, false, false, "Seguridad de los Sistemas" },
                    { 177, 6, false, false, "Administración de Sistemas Operativos y Redes" },
                    { 178, 6, false, false, "Práctica Profesionalizante II" },
                    { 179, 17, false, false, "Psicología y Educación" },
                    { 180, 17, false, false, "Pedagogía" },
                    { 181, 17, false, false, "Sociología de la Educación" },
                    { 182, 17, false, false, "Historia Argentina y Latinoamericana (1º cuatr.)" },
                    { 183, 17, false, false, "Movimiento y Cuerpo I" },
                    { 184, 17, false, false, "Taller de Práctica I" },
                    { 185, 17, false, false, "Problemáticas Contemporáneas de la Educación Inicial I" },
                    { 186, 17, false, false, "Comunicación y Expresión Oral y Escrita" },
                    { 187, 17, false, false, "Resolución de Problemas y Creatividad (1º cuatr.)" },
                    { 188, 17, false, false, "Ambiente y Sociedad (2º cuatr.)" },
                    { 189, 17, false, false, "Área Estético-Expresiva I" },
                    { 190, 17, false, false, "Itinerarios por el Mundo de la Cultura" },
                    { 191, 17, false, false, "Producción Pedagógica" },
                    { 192, 18, false, false, "Didáctica General" },
                    { 193, 18, false, false, "Filosofía de la Educación (1º cuatr.)" },
                    { 194, 18, false, false, "Conocimiento y Educación (2º cuatr.)" },
                    { 195, 18, false, false, "Movimiento y Cuerpo II" },
                    { 196, 18, false, false, "Taller de Práctica II: Seminario de lo Grupal y los Grupos de Aprendizaje" },
                    { 197, 18, false, false, "Sujeto de la Educación Inicial" },
                    { 198, 18, false, false, "Didáctica de Educación Inicial I" },
                    { 199, 18, false, false, "Matemática y su Didáctica I" },
                    { 200, 18, false, false, "Literatura y su Didáctica" },
                    { 201, 18, false, false, "Ciencias Naturales y su Didáctica" },
                    { 202, 18, false, false, "Itinerarios por el Mundo de la Cultura" },
                    { 203, 18, false, false, "Producción Pedagógica" },
                    { 204, 19, false, false, "Tecnologías de la Información y de la Comunicación" },
                    { 205, 19, false, false, "Historia Social de la Educación y Política Educativa Argentina" },
                    { 206, 19, false, false, "Trayecto de Práctica III: Seminario de Instituciones Educativas" },
                    { 207, 19, false, false, "Matemática y su Didáctica II" },
                    { 208, 19, false, false, "Lengua y su Didáctica (1º cuatr.)" },
                    { 209, 19, false, false, "Alfabetización Inicial (2º cuatr.)" },
                    { 210, 19, false, false, "Ciencias Sociales y su Didáctica" },
                    { 211, 19, false, false, "Área Estético-Expresiva II" },
                    { 212, 19, false, false, "Problemáticas Contemporáneas de la Educación Inicial II (1º cuatr.)" },
                    { 213, 19, false, false, "Didáctica de la Educación Inicial II (2º cuatr.)" },
                    { 214, 19, false, false, "Espacios de Definición Institucional (1º cuatr.)" },
                    { 215, 19, false, false, "Espacios de Definición Institucional (2º cuatr.)" },
                    { 216, 19, false, false, "Itinerarios por el Mundo de la Cultura" },
                    { 217, 19, false, false, "Producción Pedagógica" },
                    { 218, 20, false, false, "Ética, Trabajo Docente, Derechos Humanos y Ciudadanos" },
                    { 219, 20, false, false, "Taller de Práctica IV" },
                    { 220, 20, false, false, "Ateneo: (Matemática- Ambiente y Sociedad (Ciencias Naturales- Ciencias Sociales) Lengua y Literatura- Formación Ética y Ciudadana)" },
                    { 221, 20, false, false, "Sexualidad Humana y Educación (1º cuatr.)" },
                    { 222, 20, false, false, "Itinerarios por el Mundo de la Cultura" },
                    { 223, 20, false, false, "Producción Pedagógica" },
                    { 224, 13, false, false, "Pedagogía" },
                    { 225, 13, false, false, "UCCV Sociología" },
                    { 226, 13, false, false, "Administración General" },
                    { 227, 13, false, false, "Administración I" },
                    { 228, 13, false, false, "Sistema de Información Contable I" },
                    { 229, 13, false, false, "Construcción de Ciudadanía" },
                    { 230, 13, false, false, "Historia Económica" },
                    { 231, 13, false, false, "Matemática" },
                    { 232, 13, false, false, "Práctica Docente I" },
                    { 233, 14, false, false, "Instituciones Educativas" },
                    { 234, 14, false, false, "Didáctica y Curriculum" },
                    { 235, 14, false, false, "Psicología y Educación" },
                    { 236, 14, false, false, "Administración II" },
                    { 237, 14, false, false, "Sistema de Información Contable II" },
                    { 238, 14, false, false, "Derecho I" },
                    { 239, 14, false, false, "Economía" },
                    { 240, 14, false, false, "Estadística Aplicada" },
                    { 241, 14, false, false, "Didáctica de la Administración I" },
                    { 242, 14, false, false, "Práctica Docencia II" },
                    { 243, 15, false, false, "Historia y Política de la Educación Argentina" },
                    { 244, 15, false, false, "Filosofía" },
                    { 245, 15, false, false, "Metodología de la Investigación" },
                    { 246, 15, false, false, "Administración III" },
                    { 247, 15, false, false, "Sistema de Información Contable III" },
                    { 248, 15, false, false, "Práctica Impositiva y Laboral" },
                    { 249, 15, false, false, "Derecho II" },
                    { 250, 15, false, false, "Didáctica de la Administración II" },
                    { 251, 15, false, false, "Sujetos de la Educación Secundaria" },
                    { 252, 15, false, false, "Práctica Docente III" },
                    { 253, 15, false, false, "Producción de los Recursos Didácticos I" },
                    { 254, 16, false, false, "Ética y Trabajo Docente" },
                    { 255, 16, false, false, "Educación Sexual Integral" },
                    { 256, 16, false, false, "UCCV Comunicación Social" },
                    { 257, 16, false, false, "Administración IV" },
                    { 258, 16, false, false, "Gestión Organizacional" },
                    { 259, 16, false, false, "Matemática Financiera" },
                    { 260, 16, false, false, "Prácticas de Investigación" },
                    { 261, 16, false, false, "Práctica Docente IV (Residencia)" },
                    { 262, 16, false, false, "Producción de los Recursos Didácticos II" },
                    { 263, 16, false, false, "Unidad de Definición Institucional" },
                    { 264, 1, false, false, "Recreo" },
                    { 265, 2, false, false, "Recreo" },
                    { 266, 3, false, false, "Recreo" },
                    { 267, 4, false, false, "Recreo" },
                    { 268, 5, false, false, "Recreo" },
                    { 269, 6, false, false, "Recreo" },
                    { 270, 7, false, false, "Recreo" },
                    { 271, 8, false, false, "Recreo" },
                    { 272, 9, false, false, "Recreo" },
                    { 273, 10, false, false, "Recreo" },
                    { 274, 11, false, false, "Recreo" },
                    { 275, 12, false, false, "Recreo" },
                    { 276, 13, false, false, "Recreo" },
                    { 277, 14, false, false, "Recreo" },
                    { 278, 15, false, false, "Recreo" },
                    { 279, 16, false, false, "Recreo" },
                    { 280, 17, false, false, "Recreo" },
                    { 281, 18, false, false, "Recreo" },
                    { 282, 19, false, false, "Recreo" },
                    { 283, 20, false, false, "Recreo" },
                    { 284, 21, false, false, "Recreo" },
                    { 285, 22, false, false, "Recreo" },
                    { 286, 23, false, false, "Recreo" },
                    { 287, 24, false, false, "Recreo" },
                    { 288, 25, false, false, "Recreo" },
                    { 289, 26, false, false, "Recreo" },
                    { 290, 27, false, false, "Recreo" },
                    { 291, 28, false, false, "Recreo" }
                });
